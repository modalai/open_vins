...
class TrackCVP : public TrackBase {
  ...
  public:
    ...
    explicit TrackCVP(std::unordered_map<size_t, std::shared_ptr<CamBase>> cameras, int numfeats, int numaruco, bool stereo,
                      ...
                      std::vector<mcv_fpx_feature_t *> *mcv_features_in)
  ...
  protected:
    ...
    void perform_orb_detection_monocular(const cv::Mat &img0, const cv::Mat &mask0, std::vector<size_t> &ids0,
    ...
    void robust_orb_match(const cv::Mat &img1, mcv_dcm_pos_t *positions1, size_t n_pos1, const cv::Mat &img0, mcv_dcm_pos_t *positions0,
                          size_t n_pos0, size_t id0, size_t id1, std::vector<cv::DMatch> &matches);
